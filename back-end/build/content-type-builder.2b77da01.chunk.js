...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(1565);
...
var utils = __webpack_require__(62485);
...
const LinkWrapper = (0,styled_components_browser_esm["default"])((0,BaseButton/* BaseButtonWrapper */.G)) `
  &[aria-disabled='true'] {
...
const LinkButton = react.forwardRef(({ variant = 'default', startIcon, endIcon, disabled = false, children, size = 'S', href, to, ...props }, ref) => {
    ...
    const paddingY = 4;
    return ((0,jsx_runtime.jsxs)(LinkWrapper, { ref: ref, "aria-disabled": disabled, size: size, variant: variant, target: target, rel: rel, to: disabled ? undefined : to, href: disabled ? '#' : href, background: "buttonPrimary600", borderColor: "buttonPrimary600", hasRadius: true, gap: 2, inline: true, paddingBottom: paddingX, paddingLeft: paddingY, paddingRight: paddingY, paddingTop: paddingX, pointerEvents: disabled ? 'none' : undefined, ...props, as: to && !disabled ? react_router_dom.NavLink : 'a', children: [startIcon && (0,jsx_runtime.jsx)(Flex/* Flex */.k, { "aria-hidden": true, children: startIcon }), (0,jsx_runtime.jsx)(Typography/* Typography */.Z, { variant: size === 'S' ? 'pi' : undefined, fontWeight: "bold", textColor: "buttonNeutral0", children: children }), endIcon && (0,jsx_runtime.jsx)(Flex/* Flex */.k, { "aria-hidden": true, children: endIcon })] }));
});
...
var themes_utils = __webpack_require__(66362);
